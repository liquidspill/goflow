...
func main() {
	...
	transformFunc := func(msgDec interface{}, null interface{}) ([]*flowmessage.FlowMessage, error) {
		return producer.ProcessMessageNetFlowLegacy(msgDec)
	}

	s := &utils.StateNFLegacy[flowmessage.FlowMessage]{
